...
public class Inventory : MonoBehaviour
{
    ...
    [Header("Audio Clips")]
    [SerializeField] AudioClip pickupItemAudioClip;
    [SerializeField] AudioClip dropItemAudioClip;
    ...
    public void OnTrggerEnter(Collider other)
    {
        if (other.CompareTag("DroppedItem"))
        {
            ...
            audioSource.PlayOneShot(pickupItemAudioClip);
        }
    }
    ...
    public void DropItem(string inventoryId)
    {
        ...
        audioSource.PlayOneShot(dropItemAudioClip);
    }
}